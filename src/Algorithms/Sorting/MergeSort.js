...
const merger = (childDom1, childDom2, childArr1, childArr2, parDom, tl) => {
    timeline.add(lineFocusRemover(lineDoms[8]));
    timeline.add(lineFocuser(lineDoms[10]));
    attachLabel(timeline);
    timeline.add(lineFocusRemover(lineDoms[10]));
    timeline.add(lineFocuser(lineDoms[11]));
    attachLabel(timeline);
    timeline.add(lineFocusRemover(lineDoms[11]));
    let i, j, child1, child2, divs, index;
    let new_arr = [];
    i = j = index = 0;
    let kids = [];
    ...
    timeline.add(lineFocuser(lineDoms[12]));
    attachLabel(timeline);
    timeline.add(lineFocusRemover(lineDoms[12]));
    timeline.add(lineFocuser(lineDoms[13]));
    while (i < child1.length && j < child2.length) {
        timeline.add(focusAdder(child1[i]));
        timeline.add(focusAdder(child2[j]));
        attachLabel(timeline);
        timeline.add(lineFocusRemover(lineDoms[13]));
        timeline.add(lineFocuser(lineDoms[14]));
        attachLabel(timeline);
        if (Number(child1[i].innerText) <= Number(child2[j].innerText)) {
            timeline.add(lineFocusRemover(lineDoms[14]));
            timeline.add(lineFocuser(lineDoms[15]));
            ...
            i++;
            attachLabel(timeline);
            timeline.add(lineFocusRemover(lineDoms[15]));
            timeline.add(lineFocuser(lineDoms[16]));
            attachLabel(timeline);
            timeline.add(lineFocusRemover(lineDoms[16]));
        } else {
            timeline.add(lineFocusRemover(lineDoms[14]));
            timeline.add(lineFocuser(lineDoms[17]));
            attachLabel(timeline);
            timeline.add(lineFocusRemover(lineDoms[17]));
            timeline.add(lineFocuser(lineDoms[18]));
            ...
            j++;
            attachLabel(timeline);
            timeline.add(lineFocusRemover(lineDoms[18]));
            timeline.add(lineFocuser(lineDoms[19]));
            attachLabel(timeline);
            timeline.add(lineFocusRemover(lineDoms[19]));
        }
        timeline.add(lineFocuser(lineDoms[13]));
    }
    attachLabel(timeline);
    ...
    timeline.add(lineFocuser(lineDoms[20]));
    attachLabel(timeline);
    timeline.add(lineFocusRemover(lineDoms[20]));
    return divs;
};
const down = (dom) => {
...
export default function merge_sort(tl, domObjects, lineDom, parDom) {
    timeline = tl;
    lineDoms = lineDom;
